  ...
  export default {
    ...
    methods : {
      personList(page = 1, search = '', criteria = 'name'){
        let me = this
        var url = 'index.php/client?page=' + page + '&search=' + search + '&criteria=' + criteria
      ...
      storePerson(){
        ...
        let me = this
          axios.post('index.php/client/store', {
            'name': this.name,
      ...
      updatePerson(){
        ...
        let me = this
          axios.put('index.php/client/update', {
            'id' : this.person_id,
            'name': this.name,
            'document_type': this.document_type,
            'document_num': this.document_num,
      ...
      personDesactivate(id){
        ...
        .then((willDelete) => {
          if (willDelete) {
            let me = this
            axios.put('index.php/client/deactivate', {
              'id' : id
            }).then(function(response){
      ...
      personActivate(id){
        ...
        .then((willDelete) => {
          if (willDelete) {
            let me = this
            axios.put('index.php/client/activate', {
              'id' : id
            }).then(function(response){
