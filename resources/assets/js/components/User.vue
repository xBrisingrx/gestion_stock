                  ...
                  <table class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                          <tr v-for="person in arrayPerson" :key="person.id">
                              ...
                              <td v-text="person.user_name"></td>
                              <td v-text="person.rol_name"></td>
                              <td>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="form-group row">
                              <label class="col-md-3 form-control-label" for="text-input">Num DNI/CUIT(*)</label>
                              <div class="col-md-9">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  <input type="text" v-model="user_name" class="form-control" placeholder="Nombre del usuario">
                              </div>
                          </div>
                          <div class="form-group row">
  ...
  export default {
    ...
    methods : {
      personList(page = 1, search = '', criteria = 'name'){
        let me = this
        var url = 'index.php/user?page=' + page + '&search=' + search + '&criteria=' + criteria
      ...
      selectRol(){
        let me = this
        var url = 'index.php/rol/selectRol'
        axios.get(url).then( function (response){
          var resp = response.data
          me.arrayRol = resp.roles
        })
        .catch(function(error){
          console.log(error)
        })
      ...
      storePerson(){
        ...
        let me = this
          axios.post('index.php/user/store', {
            'name': this.name,
      ...
      updatePerson(){
        ...
        let me = this
          axios.put('index.php/user/update', {
            'id' : this.person_id,
            'name': this.name,
            'document_type': this.document_type,
            'document_num': this.document_num,
      ...
      validatePerson(){
        ...
        if (!this.user_name) this.personErrorMsg.push('El nombre del usuario no puede estar vacio.')
        if (!this.password) this.personErrorMsg.push('El password no puede estar vacio.')
        if (this.rol_id == 0) this.personErrorMsg.push('Debe seleccionar un rol.')
      ...
      personDesactivate(id){
        ...
        .then((willDelete) => {
          if (willDelete) {
            let me = this
            axios.put('index.php/user/deactivate', {
              'id' : id
            }).then(function(response){
      ...
      personActivate(id){
        ...
        .then((willDelete) => {
          if (willDelete) {
            let me = this
            axios.put('index.php/user/activate', {
              'id' : id
            }).then(function(response){
